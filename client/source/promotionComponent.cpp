...
PromotionComponent::PromotionComponent(int pos, bool color)
{
    ...
    if (color)
    {
        ...
        whitePromotionChoices[0].setPosition(sf::Vector2f(posX * OBJECT_SIZE_F, posY * OBJECT_SIZE_F));
        ...
        whitePromotionChoices[1].setPosition(sf::Vector2f(posX * OBJECT_SIZE_F, (posY + 1) * OBJECT_SIZE_F));
        ...
        whitePromotionChoices[2].setPosition(sf::Vector2f(posX * OBJECT_SIZE_F, (posY + 2) * OBJECT_SIZE_F));
        ...
        whitePromotionChoices[3].setPosition(sf::Vector2f(posX * OBJECT_SIZE_F, (posY + 3) * OBJECT_SIZE_F));
    ...
    else 
    {
        ...
        blackPromotionChoices[0].setPosition(sf::Vector2f(posX * OBJECT_SIZE_F, posY * OBJECT_SIZE_F));
        ...
        blackPromotionChoices[1].setPosition(sf::Vector2f(posX * OBJECT_SIZE_F, (posY + 1) * OBJECT_SIZE_F));
        ...
        blackPromotionChoices[2].setPosition(sf::Vector2f(posX * OBJECT_SIZE_F, (posY + 2) * OBJECT_SIZE_F));
        ...
        blackPromotionChoices[3].setPosition(sf::Vector2f(posX * OBJECT_SIZE_F, (posY + 3) * OBJECT_SIZE_F));
